...
const settings = new Map([
    ...
    ["openai_api_key_field", {name: "Chiave API OpenAI", type: TextareaControl, description: "La chiave API di OpenAI"}],
    ["openai_whatsapp_token_field", {name: "Token WhatsApp", type: TextareaControl, description: "Il token di WhatsApp"}],
    ["openai_whatsapp_outcoming_number_id_field", {name: "ID del numero di uscita di WhatsApp", type: TextControl, description: "L'ID del numero di uscita di WhatsApp"}],
    ["openai_whatsapp_associate_assistant_field", {name: "Associare l'assistente a WhatsApp", type: QuoteAssistantsSelectControl, description: "Associare l'assistente a WhatsApp"}], 
