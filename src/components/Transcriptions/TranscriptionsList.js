    ...
    const actions=[
        {
          RenderModal: (item) => { 
            ...
            return <ConfirmDeleteTranscription fileName={item.items[0].file_id} onConfirm={handleConfirmDelete} onCancel={handleCancelDelete} closeModal={item.closeModal} videoTitle={item.items[0].videoTitle} /> 
          },
